  ...
  export interface Typegen0 {
    '@@xstate/typegen': true;
    internalEvents: {
      'done.invoke.Keyring.Loading:invocation[0]': {
        type: 'done.invoke.Keyring.Loading:invocation[0]';
        data: unknown;
        __tip: 'See the XState TS docs to learn how to strongly type this.';
      };
      'error.platform.Keyring.Loading:invocation[0]': {
        type: 'error.platform.Keyring.Loading:invocation[0]';
        data: unknown;
      };
