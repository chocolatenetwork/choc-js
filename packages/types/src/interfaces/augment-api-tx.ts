...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    chocolateModule: {
       ...
       **/
      acceptProject: AugmentedSubmittable<
        (
          projectId: u32 | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [u32]
      >;
      /**
       ...
       *
       **/
      acceptReview: AugmentedSubmittable<
        (
          userId: AccountId32 | string | Uint8Array,
          projectId: u32 | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [AccountId32, u32]
      >;
       ...
       **/
      createProject: AugmentedSubmittable<
        (
          projectMeta: Bytes | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [Bytes]
      >;
      /**
       ...
       **/
      createReview: AugmentedSubmittable<
        (
          reviewMeta:
            | ITuple<[u8, Bytes]>
        ...
        [ITuple<[u8, Bytes]>, u32, ParachainTemplateRuntimeCurrencyId]
      >;
      /**
       * Generic tx
       **/
    ...
    currencies: {
      ...
      transfer: AugmentedSubmittable<
        ...
        [MultiAddress, ParachainTemplateRuntimeCurrencyId, Compact<u128>]
      >;
      /**
      ...
      updateBalance: AugmentedSubmittable<
        ...
        [MultiAddress, ParachainTemplateRuntimeCurrencyId, i128]
      >;
      /**
       * Generic tx
       **/
    ...
    mintingModule: {
      mint: AugmentedSubmittable<
        (x: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [u128]
      >;
      /**
       * Generic tx
    ...
    session: {
      ...
      setKeys: AugmentedSubmittable<
        ...
        [ParachainTemplateRuntimeSessionKeys, Bytes]
      >;
      /**
       * Generic tx
       **/
    ...
    templatePallet: {
      ...
      testRes: AugmentedSubmittable<
        ...
        [ParachainTemplateRuntimeCurrencyId, u128]
      >;
      /**
       * UnReserves some amount of generic assets for the roigin
       **/
      testUnres: AugmentedSubmittable<
        (
          currencyId:
            | ParachainTemplateRuntimeCurrencyId
            | 'Native'
       ...
       **/
      testUnresTo: AugmentedSubmittable<
        (
          currencyId:
            | ParachainTemplateRuntimeCurrencyId
            | 'Native'
        ...
        [ParachainTemplateRuntimeCurrencyId, AccountId32, u128]
      >;
      /**
       * Generic tx
       **/
    ...
    xcmpQueue: {
       ...
       **/
      resumeXcmExecution: AugmentedSubmittable<
        () => SubmittableExtrinsic<ApiType>,
        []
      >;
      /**
       ...
       * - `origin`: Must pass `ControllerOrigin`.
       **/
      suspendXcmExecution: AugmentedSubmittable<
        () => SubmittableExtrinsic<ApiType>,
        []
      >;
      /**
      ...
      updateThresholdWeight: AugmentedSubmittable<
        (
          updated: u64 | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [u64]
      >;
      /**
