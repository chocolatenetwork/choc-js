...
import type { Bytes, Compact, Option, Vec, bool, i128, u128, u32, u64, u8 } from '@polkadot/types-codec';
import type { AnyNumber, IMethod, ITuple } from '@polkadot/types-codec/types';
import type { AccountId32, Call, H256, MultiAddress, Perbill } from '@polkadot/types/interfaces/runtime';
import type { CumulusPrimitivesParachainInherentParachainInherentData, PalletElectionsPhragmenRenouncing, ParachainTemplateRuntimeCurrencyId, ParachainTemplateRuntimeSessionKeys, SpRuntimeHeader, XcmV1MultiLocation, XcmV2WeightLimit, XcmVersionedMultiAssets, XcmVersionedMultiLocation, XcmVersionedXcm } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    chocolateModule: {
       ...
       * 
       **/
      acceptReview: AugmentedSubmittable<(userId: AccountId32 | string | Uint8Array, projectId: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, u32]>;
      /**
       * Create a project
       * 
       ...
       **/
      createReview: AugmentedSubmittable<(reviewMeta: ITuple<[u8, Bytes]> | [u8 | AnyNumber | Uint8Array, Bytes | string | Uint8Array], projectId: u32 | AnyNumber | Uint8Array, collateralCurrencyId: ParachainTemplateRuntimeCurrencyId | 'Native' | 'DOT' | 'KSM' | 'BTC' | number | Uint8Array) => SubmittableExtrinsic<ApiType>, [ITuple<[u8, Bytes]>, u32, ParachainTemplateRuntimeCurrencyId]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    currencies: {
       ...
       * transactor.
       **/
      transfer: AugmentedSubmittable<(dest: MultiAddress | { Id: any } | { Index: any } | { Raw: any } | { Address32: any } | { Address20: any } | string | Uint8Array, currencyId: ParachainTemplateRuntimeCurrencyId | 'Native' | 'DOT' | 'KSM' | 'BTC' | number | Uint8Array, amount: Compact<u128> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MultiAddress, ParachainTemplateRuntimeCurrencyId, Compact<u128>]>;
      /**
       ...
       **/
      updateBalance: AugmentedSubmittable<(who: MultiAddress | { Id: any } | { Index: any } | { Raw: any } | { Address32: any } | { Address20: any } | string | Uint8Array, currencyId: ParachainTemplateRuntimeCurrencyId | 'Native' | 'DOT' | 'KSM' | 'BTC' | number | Uint8Array, amount: i128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MultiAddress, ParachainTemplateRuntimeCurrencyId, i128]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    mintingModule: {
      mint: AugmentedSubmittable<(x: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u128]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    templatePallet: {
       ...
       **/
      testRes: AugmentedSubmittable<(currencyId: ParachainTemplateRuntimeCurrencyId | 'Native' | 'DOT' | 'KSM' | 'BTC' | number | Uint8Array, amount: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [ParachainTemplateRuntimeCurrencyId, u128]>;
      /**
       * UnReserves some amount of generic assets for the roigin
       **/
      testUnres: AugmentedSubmittable<(currencyId: ParachainTemplateRuntimeCurrencyId | 'Native' | 'DOT' | 'KSM' | 'BTC' | number | Uint8Array, amount: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [ParachainTemplateRuntimeCurrencyId, u128]>;
      /**
       ...
       **/
      testUnresTo: AugmentedSubmittable<(currencyId: ParachainTemplateRuntimeCurrencyId | 'Native' | 'DOT' | 'KSM' | 'BTC' | number | Uint8Array, to: AccountId32 | string | Uint8Array, amount: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [ParachainTemplateRuntimeCurrencyId, AccountId32, u128]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
