...
import type { ChocolatePrimitivesProjectsProject, ChocolatePrimitivesProjectsReview, ChocolatePrimitivesUsersUser, CumulusPalletDmpQueueConfigData, CumulusPalletDmpQueuePageIndexData, CumulusPalletParachainSystemRelayStateSnapshotMessagingStateSnapshot, CumulusPalletXcmpQueueInboundChannelDetails, CumulusPalletXcmpQueueOutboundChannelDetails, CumulusPalletXcmpQueueQueueConfigData, FrameSupportWeightsPerDispatchClassU64, FrameSystemAccountInfo, FrameSystemEventRecord, FrameSystemLastRuntimeUpgradeInfo, FrameSystemPhase, OrmlTokensAccountData, OrmlTokensBalanceLock, OrmlTokensReserveData, PalletAuthorshipUncleEntryItem, PalletBalancesAccountData, PalletBalancesBalanceLock, PalletBalancesReleases, PalletBalancesReserveData, PalletCollatorSelectionCandidateInfo, PalletCollectiveVotes, PalletElectionsPhragmenSeatHolder, PalletElectionsPhragmenVoter, PalletTransactionPaymentReleases, PalletTreasuryProposal, ParachainTemplateRuntimeCurrencyId, ParachainTemplateRuntimeSessionKeys, PolkadotCorePrimitivesOutboundHrmpMessage, PolkadotPrimitivesV2AbridgedHostConfiguration, PolkadotPrimitivesV2PersistedValidationData, PolkadotPrimitivesV2UpgradeRestriction, SpConsensusAuraSr25519AppSr25519Public, SpCoreCryptoKeyTypeId, SpRuntimeDigest, SpTrieStorageProof } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    chocolateModule: {
       ...
       **/
      nextProjectIndex: AugmentedQuery<ApiType, () => Observable<Option<u32>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Storage map from the project index - id to the projects. getters are for json rpc.
       **/
      projects: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<ChocolatePrimitivesProjectsProject>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       ...
       **/
      reviews: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: u32 | AnyNumber | Uint8Array) => Observable<Option<ChocolatePrimitivesProjectsReview>>, [AccountId32, u32]> & QueryableStorageEntry<ApiType, [AccountId32, u32]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    session: {
       ...
       **/
      nextKeys: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<ParachainTemplateRuntimeSessionKeys>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       ...
       **/
      queuedKeys: AugmentedQuery<ApiType, () => Observable<Vec<ITuple<[AccountId32, ParachainTemplateRuntimeSessionKeys]>>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
    ...
    tokens: {
       ...
       * balances.
       **/
      accounts: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: ParachainTemplateRuntimeCurrencyId | 'Native' | 'DOT' | 'KSM' | 'BTC' | number | Uint8Array) => Observable<OrmlTokensAccountData>, [AccountId32, ParachainTemplateRuntimeCurrencyId]> & QueryableStorageEntry<ApiType, [AccountId32, ParachainTemplateRuntimeCurrencyId]>;
      /**
       * Any liquidity locks of a token type under an account.
       * NOTE: Should only be accessed when setting, changing and freeing a lock.
       **/
      locks: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: ParachainTemplateRuntimeCurrencyId | 'Native' | 'DOT' | 'KSM' | 'BTC' | number | Uint8Array) => Observable<Vec<OrmlTokensBalanceLock>>, [AccountId32, ParachainTemplateRuntimeCurrencyId]> & QueryableStorageEntry<ApiType, [AccountId32, ParachainTemplateRuntimeCurrencyId]>;
      /**
       * Named reserves on some account balances.
       **/
      reserves: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: ParachainTemplateRuntimeCurrencyId | 'Native' | 'DOT' | 'KSM' | 'BTC' | number | Uint8Array) => Observable<Vec<OrmlTokensReserveData>>, [AccountId32, ParachainTemplateRuntimeCurrencyId]> & QueryableStorageEntry<ApiType, [AccountId32, ParachainTemplateRuntimeCurrencyId]>;
      /**
       * The total issuance of a token type.
       **/
      totalIssuance: AugmentedQuery<ApiType, (arg: ParachainTemplateRuntimeCurrencyId | 'Native' | 'DOT' | 'KSM' | 'BTC' | number | Uint8Array) => Observable<u128>, [ParachainTemplateRuntimeCurrencyId]> & QueryableStorageEntry<ApiType, [ParachainTemplateRuntimeCurrencyId]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    usersModule: {
       ...
       * users store
       **/
      users: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<ChocolatePrimitivesUsersUser>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
