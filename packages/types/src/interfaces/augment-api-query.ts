...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    chocolateModule: {
       ...
       **/
      nextProjectIndex: AugmentedQuery<
        ApiType,
       ...
       **/
      projects: AugmentedQuery<
        ApiType,
        (
          arg: u32 | AnyNumber | Uint8Array
        ) => Observable<Option<ChocolatePrimitivesProjectsProject>>,
        [u32]
      > &
       ...
       **/
      reviews: AugmentedQuery<
        ApiType,
        (
          arg1: AccountId32 | string | Uint8Array,
          arg2: u32 | AnyNumber | Uint8Array
        ) => Observable<Option<ChocolatePrimitivesProjectsReview>>,
        [AccountId32, u32]
      > &
    ...
    session: {
      ...
      nextKeys: AugmentedQuery<
        ...
        (
          arg: AccountId32 | string | Uint8Array
        ) => Observable<Option<ParachainTemplateRuntimeSessionKeys>>,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
      ...
      queuedKeys: AugmentedQuery<
        ApiType,
        () => Observable<
          Vec<ITuple<[AccountId32, ParachainTemplateRuntimeSessionKeys]>>
        >,
        []
      > &
        QueryableStorageEntry<ApiType, []>;
    ...
    tokens: {
      ...
      totalIssuance: AugmentedQuery<
        ...
        [ParachainTemplateRuntimeCurrencyId]
      > &
        QueryableStorageEntry<ApiType, [ParachainTemplateRuntimeCurrencyId]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    usersModule: {
       ...
       * users store
       **/
      users: AugmentedQuery<
        ApiType,
        (
          arg: AccountId32 | string | Uint8Array
        ) => Observable<Option<ChocolatePrimitivesUsersUser>>,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
