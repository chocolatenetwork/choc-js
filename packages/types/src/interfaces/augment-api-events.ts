...
import type { FrameSupportTokensMiscBalanceStatus, FrameSupportWeightsDispatchInfo, ParachainTemplateRuntimeCurrencyId, SpRuntimeDispatchError, XcmV1MultiLocation, XcmV2Response, XcmV2TraitsError, XcmV2TraitsOutcome, XcmV2Xcm, XcmVersionedMultiAssets, XcmVersionedMultiLocation } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    tokens: {
       ...
       * A balance was set by root.
       **/
      BalanceSet: AugmentedEvent<ApiType, [currencyId: ParachainTemplateRuntimeCurrencyId, who: AccountId32, free: u128, reserved: u128], { currencyId: ParachainTemplateRuntimeCurrencyId, who: AccountId32, free: u128, reserved: u128 }>;
      /**
       * Deposited some balance into an account
       **/
      Deposited: AugmentedEvent<ApiType, [currencyId: ParachainTemplateRuntimeCurrencyId, who: AccountId32, amount: u128], { currencyId: ParachainTemplateRuntimeCurrencyId, who: AccountId32, amount: u128 }>;
      /**
       * An account was removed whose balance was non-zero but below
       * ExistentialDeposit, resulting in an outright loss.
       **/
      DustLost: AugmentedEvent<ApiType, [currencyId: ParachainTemplateRuntimeCurrencyId, who: AccountId32, amount: u128], { currencyId: ParachainTemplateRuntimeCurrencyId, who: AccountId32, amount: u128 }>;
      /**
       * An account was created with some free balance.
       **/
      Endowed: AugmentedEvent<ApiType, [currencyId: ParachainTemplateRuntimeCurrencyId, who: AccountId32, amount: u128], { currencyId: ParachainTemplateRuntimeCurrencyId, who: AccountId32, amount: u128 }>;
      /**
       * Some locked funds were unlocked
       **/
      LockRemoved: AugmentedEvent<ApiType, [lockId: U8aFixed, currencyId: ParachainTemplateRuntimeCurrencyId, who: AccountId32], { lockId: U8aFixed, currencyId: ParachainTemplateRuntimeCurrencyId, who: AccountId32 }>;
      /**
       * Some funds are locked
       **/
      LockSet: AugmentedEvent<ApiType, [lockId: U8aFixed, currencyId: ParachainTemplateRuntimeCurrencyId, who: AccountId32, amount: u128], { lockId: U8aFixed, currencyId: ParachainTemplateRuntimeCurrencyId, who: AccountId32, amount: u128 }>;
      /**
       * Some balance was reserved (moved from free to reserved).
       **/
      Reserved: AugmentedEvent<ApiType, [currencyId: ParachainTemplateRuntimeCurrencyId, who: AccountId32, amount: u128], { currencyId: ParachainTemplateRuntimeCurrencyId, who: AccountId32, amount: u128 }>;
      /**
       * Some reserved balance was repatriated (moved from reserved to
       * another account).
       **/
      ReserveRepatriated: AugmentedEvent<ApiType, [currencyId: ParachainTemplateRuntimeCurrencyId, from: AccountId32, to: AccountId32, amount: u128, status: FrameSupportTokensMiscBalanceStatus], { currencyId: ParachainTemplateRuntimeCurrencyId, from: AccountId32, to: AccountId32, amount: u128, status: FrameSupportTokensMiscBalanceStatus }>;
      /**
       * Some balances were slashed (e.g. due to mis-behavior)
       **/
      Slashed: AugmentedEvent<ApiType, [currencyId: ParachainTemplateRuntimeCurrencyId, who: AccountId32, freeAmount: u128, reservedAmount: u128], { currencyId: ParachainTemplateRuntimeCurrencyId, who: AccountId32, freeAmount: u128, reservedAmount: u128 }>;
      /**
       * The total issuance of an currency has been set
       **/
      TotalIssuanceSet: AugmentedEvent<ApiType, [currencyId: ParachainTemplateRuntimeCurrencyId, amount: u128], { currencyId: ParachainTemplateRuntimeCurrencyId, amount: u128 }>;
      /**
       * Transfer succeeded.
       **/
      Transfer: AugmentedEvent<ApiType, [currencyId: ParachainTemplateRuntimeCurrencyId, from: AccountId32, to: AccountId32, amount: u128], { currencyId: ParachainTemplateRuntimeCurrencyId, from: AccountId32, to: AccountId32, amount: u128 }>;
      /**
       * Some balance was unreserved (moved from reserved to free).
       **/
      Unreserved: AugmentedEvent<ApiType, [currencyId: ParachainTemplateRuntimeCurrencyId, who: AccountId32, amount: u128], { currencyId: ParachainTemplateRuntimeCurrencyId, who: AccountId32, amount: u128 }>;
      /**
       * Some balances were withdrawn (e.g. pay for transaction fee)
       **/
      Withdrawn: AugmentedEvent<ApiType, [currencyId: ParachainTemplateRuntimeCurrencyId, who: AccountId32, amount: u128], { currencyId: ParachainTemplateRuntimeCurrencyId, who: AccountId32, amount: u128 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
